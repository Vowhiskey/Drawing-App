package ua.tutorial.drawingapp
...
class MainActivity : AppCompatActivity() {
    ...
    val openGalleryLauncher:ActivityResultLauncher<Intent> =
     ...
     val imageLauncher:ActivityResultLauncher<Array<String>> =
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnIcGallery: ImageButton = findViewById(R.id.ic_gallery)
        btnIcGallery.setOnClickListener {
                ...
                try{
                    ...
                    runOnUiThread{
                        ...
                        if(result.isNotEmpty()){
                            ...
                            Toast.makeText(this@MainActivity,
                                "Something wrong with saving file : $result",
                                Toast.LENGTH_LONG).show()
                        }
                    }
